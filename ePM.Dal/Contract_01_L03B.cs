...
namespace ePM.Dal
{
    ...
    public partial class Contract_01_L03B
    {
        ...
        public string materialsproduced { get; set; }
        public string Internationaltradeterms { get; set; }
        ...
        public string Suppliedmaterials { get; set; }
        public string Durationbeforelastshipmentbydays { get; set; }
        ...
        public string agreeduponportofdelivery { get; set; }
        public string alternateportdeliverygoods { get; set; }
