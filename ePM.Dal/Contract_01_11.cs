...
namespace ePM.Dal
{
    ...
    public partial class Contract_01_11
    {
        ...
        public string Materialstobetransported { get; set; }
        public string Articlesdownloadsite { get; set; }
        public string Materialdeliverysite { get; set; }
        public string Secondhandmaterialhand { get; set; }
        public string Materialtransportcapacitybyliters { get; set; }
        public string pricemovingtrail { get; set; }
        public string Firstpartyprojectarea { get; set; }
