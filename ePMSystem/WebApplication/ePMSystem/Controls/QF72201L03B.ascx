<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QF72201L03B.ascx.cs" Inherits="ePMSystem.Controls.QF72201L03B" %>
		...
		<div class="box-body col-12">
			...
			<div class="progress" style='height: 30px; margin-top: -15px;'>
				<div class="progress-bar" role="progressbar" style="width: 100%; height: 30px; background-color: #23B3e8" aria-valuemin="0" aria-valuemax="100">
					<h3 style="text-align: center; font-size: larger; margin-top: 10px;">Contract Name:
						<asp:Label ID="lbl_ContractName" runat="server" Text="QF72201L03B - Material Supply Agreement Before Winning the tender"></asp:Label></h3>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="controls">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_contrractdate"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="controls">
						<span>
							<asp:Label ID="lbl_materialsproduced" runat="server" Text="materialsproduced"></asp:Label>
							:</span>
						<asp:TextBox ID="txt_materialsproduced" runat="server" class="form-control" placeholder="materialsproduced"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_materialsproduced"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						<span>
							...
							:</span>
						<asp:TextBox ID="txt_Internationaltradeterms" runat="server" class="form-control" placeholder="Internationaltradeterms"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_Internationaltradeterms"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_BalancePercentage"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_Internationaltradeterms"></asp:RequiredFieldValidator>
					</div>
				</div>
			</div>
				...
				<div class="col-md-3">
					<div class="controls">
						<span>
							...
							:</span>
						<asp:TextBox ID="txt_Suppliedmaterials" runat="server" class="form-control" placeholder="Suppliedmaterials"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_Suppliedmaterials"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						<span>
							...
							:</span>
						<asp:TextBox ID="txt_Durationbeforelastshipmentbydays" runat="server" class="form-control" placeholder="Durationbeforelastshipmentbydays"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_Durationbeforelastshipmentbydays"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_ApprovalDocumentValue"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						<span>
							<asp:Label ID="lbl_ApprovalDocumenttext" runat="server" Text="ApprovalDocumentHalfdaytext"></asp:Label>
							:</span>
						<asp:TextBox ID="txt_ApprovalDocumentHalfdaytext" runat="server" class="form-control" placeholder="ApprovalDocumentHalfdaytext"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_ApprovalDocumentHalfdaytext"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						<span>
							...
							:</span>
						<asp:TextBox ID="txt_agreeduponportofdelivery" runat="server" class="form-control" placeholder="agreeduponportofdelivery"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_agreeduponportofdelivery"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						<span>
							...
							:</span>
						<asp:TextBox ID="txt_alternateportdeliverygoods" runat="server" class="form-control" placeholder="alternateportdeliverygoods"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_alternateportdeliverygoods"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
				...
				<div class="col-md-3">
					<div class="controls">
						<span>
							...
							:</span>
						<asp:TextBox ID="txt_currencycode" runat="server" class="form-control" placeholder="currencycode"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_currencycode"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						<span>
							...
							:</span>
						<asp:TextBox ID="txt_currencyname" runat="server" class="form-control" placeholder="currencyname"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator27" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_currencyname"></asp:RequiredFieldValidator>
					</div>
				</div>
			</div>
			<%--Forms Area--%>
