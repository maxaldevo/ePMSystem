...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <dxwschs:ASPxScheduler ID="ASPxScheduler1" runat="server" AppointmentDataSourceID="SqlDataSource1" ClientIDMode="AutoID" Start="2021-10-05" ResourceDataSourceID="SqlDataSource2">
        <Views>
            <DayView Enabled="true"><TimeRulers>
...
<AgendaView ViewSelectorItemAdaptivePriority="1"></AgendaView>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:eMedicalConnectionString %>" SelectCommand="SELECT * FROM [Resources]"></asp:SqlDataSource>
