<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QF72201L01C.ascx.cs" Inherits="ePMSystem.Controls.QF72201L01C" %>
			...
			<div class="progress" style='height: 30px; margin-top: -15px;'>
				<div class="progress-bar" role="progressbar" style="width: 100%; height: 30px; background-color: #23B3e8" aria-valuemin="0" aria-valuemax="100">
					<h3 style="text-align: center; font-size: larger; margin-top: 10px;">Contract Name:
						<asp:Label ID="lbl_ContractName" runat="server" Text="QF72201L01C - Remeasured Maintenance Works Subcontract"></asp:Label></h3>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="controls">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_scopeofwork"></asp:RequiredFieldValidator>
					</div>
				</div>
			</div>
			<br />
			<div class="row">
				<div class="col-md-3">
					<div class="controls">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_delaypenaltyvalue"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						<span>
							...
							:</span>
						<asp:TextBox ID="txt_absentpenality" runat="server" class="form-control" placeholder="absentpenality"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_absentpenality"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="ddl_insurance"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						<span>
							<asp:Label ID="lbl_performanbond" runat="server" Text="projno"></asp:Label>
							:</span>
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="ddl_performanbond"></asp:RequiredFieldValidator>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-3">
					<div class="controls">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_contractvaluetext"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_contractvaluetext"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						<span>
							<asp:Label ID="lbl_DicountPertcentage1" runat="server" Text="DicountPertcentage1"></asp:Label>
							:</span>
						<asp:TextBox ID="txt_DicountPertcentage1" runat="server" class="form-control" placeholder="DicountPertcentage1"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_DicountPertcentage1"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						<span>
							<asp:Label ID="lbl_DicountPertcentageText1" runat="server" Text="DicountPertcentageText1"></asp:Label>
							:</span>
						<asp:TextBox ID="txt_DicountPertcentageText1" runat="server" class="form-control" placeholder="DicountPertcentageText1"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_DicountPertcentageText1"></asp:RequiredFieldValidator>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3">
					<div class="controls">
						<span>
							<asp:Label ID="lbl_BusinessText1Discount1of2" runat="server" Text="BusinessText1Discount1of2"></asp:Label>
							:</span>
						<asp:TextBox ID="txt_BusinessText1Discount1of2" runat="server" class="form-control" placeholder="BusinessText1Discount1of2"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_BusinessText1Discount1of2"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						<span>
							<asp:Label ID="lbl_BusinessText1Discount2of2" runat="server" Text="BusinessText1Discount2of2"></asp:Label>
							:</span>
						<asp:TextBox ID="txt_BusinessText1Discount2of2" runat="server" class="form-control" placeholder="BusinessText1Discount2of2"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_BusinessText1Discount2of2"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						<span>
							<asp:Label ID="lbl_DicountPertcentage2" runat="server" Text="DicountPertcentage2"></asp:Label>
							:</span>
						<asp:TextBox ID="txt_DicountPertcentage2" runat="server" class="form-control" placeholder="DicountPertcentage2"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_DicountPertcentage2"></asp:RequiredFieldValidator>
					</div>
				</div>
				<div class="col-md-3">
					<div class="controls">
						<span>
							<asp:Label ID="lbl_DicountPertcentageText2" runat="server" Text="DicountPertcentageText2"></asp:Label>
							:</span>
						<asp:TextBox ID="txt_DicountPertcentageText2" runat="server" class="form-control" placeholder="DicountPertcentageText2"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_DicountPertcentageText2"></asp:RequiredFieldValidator>
					</div>
				</div>
			</div><div class="row">
				<div class="col-md-3">
					<div class="controls">
						<span>
							<asp:Label ID="lbl_BusinessText1Discount2" runat="server" Text="BusinessText1Discount2"></asp:Label>
							:</span>
						<asp:TextBox ID="txt_BusinessText1Discount2" runat="server" class="form-control" placeholder="BusinessText1Discount2"></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" ErrorMessage="*" Display="Dynamic" ForeColor="Red" ValidationGroup="A" SetFocusOnError="true" ControlToValidate="txt_BusinessText1Discount2"></asp:RequiredFieldValidator>
					</div>
				</div>
			</div>
			<%--Forms Area--%>
